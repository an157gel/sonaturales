...
<head>
    ...
    <title>Listado de paletas</title>
    <style>
        .tablalistado {
    ...
    <body bgcolor="white">
     <center><font color="black" size="10">Listado de paletas</font></center>  
        <?php
        $mysql = new mysqli("localhost", "root", "", "base4");
        if ($mysql->connect_error)
        die("Problemas con la conexión a la base de datos");
        
    $registros = $mysql->query("select sabor,adicion,precio,diadisponible from paletas") or
